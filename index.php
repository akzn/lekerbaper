                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/logo1.jpg" alt="CoolAdmin" width="150">
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" value="<?=@$_POST['username']?>" class="au-input au-input--full" type="text" name="username" placeholder="Input Nama Tamu">
                                </div>
                                <div class="form-group">
                                    <label>No Meja</label>
                                    <input class="au-input au-input--full" type="number" name="password" placeholder="No Meja">
                                </div>
